...
function TextScript:onUpdate(comp, deltaTime)
    if self.first == true then
        local GlowBlurRoot1Lua = comp.entity.scene:findEntityBy("GlowBlur_1"):getComponent("ScriptComponent")
        self.LuaObj1 = Amaz.ScriptUtils.getLuaObj(GlowBlurRoot1Lua:getScript())
        local GlowBlurRoot2Lua = comp.entity.scene:findEntityBy("GlowBlur_2"):getComponent("ScriptComponent")
        self.LuaObj2 = Amaz.ScriptUtils.getLuaObj(GlowBlurRoot2Lua:getScript())
        local GlowBlurRoot3Lua = comp.entity.scene:findEntityBy("GlowBlur_3"):getComponent("ScriptComponent")
        self.LuaObj3 = Amaz.ScriptUtils.getLuaObj(GlowBlurRoot3Lua:getScript())
        local GlowBlurRoot4Lua = comp.entity.scene:findEntityBy("GlowBlur_4"):getComponent("ScriptComponent")
        self.LuaObj4 = Amaz.ScriptUtils.getLuaObj(GlowBlurRoot4Lua:getScript())
        local GlowBlurRoot5Lua = comp.entity.scene:findEntityBy("GlowBlur_5"):getComponent("ScriptComponent")
        self.LuaObj5 = Amaz.ScriptUtils.getLuaObj(GlowBlurRoot5Lua:getScript())
        local GlowBlurRoot6Lua = comp.entity.scene:findEntityBy("GlowBlur_6"):getComponent("ScriptComponent")
        self.LuaObj6 = Amaz.ScriptUtils.getLuaObj(GlowBlurRoot6Lua:getScript())
        local GlowBlurRoot7Lua = comp.entity.scene:findEntityBy("GlowBlur_7"):getComponent("ScriptComponent")
        self.LuaObj7 = Amaz.ScriptUtils.getLuaObj(GlowBlurRoot7Lua:getScript())
        local GlowBlurRoot8Lua = comp.entity.scene:findEntityBy("GlowBlur_8"):getComponent("ScriptComponent")
